...
if(isset($_REQUEST['pwdrst']))
{
  ...
  if($pwd == $cpwd)
  {
    $reset_pwd = mysqli_query($conn,"update registration set password='$pwd' where email='$email'");
    if($reset_pwd>0)
    {
      $msg = 'Your password updated successfully <a href="loginForm.php">Click here</a> to login';
    }
    else
    {
...
if($_GET['secret'])
{
  ...
  $check_details = mysqli_query($conn,"select email from registration where email='$email'");
